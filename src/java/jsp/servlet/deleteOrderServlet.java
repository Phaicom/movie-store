    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            if(id != null){
                ...
                User_order.deleteOrder(order_id);
            }
        }catch(Exception ex){
            System.out.println("deleteOrderServlet error: "+ex);
        }
        ...
        try {
            ...
            List<User_order> list = dao.viewAllOrder((page - 1) * recordsPerPage,
                    recordsPerPage);
        ...
        getServletContext().getRequestDispatcher("/order_list.jsp").forward(request, response);
    }
