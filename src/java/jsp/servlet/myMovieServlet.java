...
public class myMovieServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Movie> list = dao.viewAllMovie(uid,(page - 1) * recordsPerPage,
                    recordsPerPage);
            if (category != null) {
                list = dao.viewAllMovie(uid,category, (page - 1) * recordsPerPage,
                        recordsPerPage);
            }
            ...
            System.out.println("myMovieServlet error: " + ex);
        }
